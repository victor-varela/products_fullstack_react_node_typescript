 ...
 * - La vista EditProducts usa un loader por ello lo definimos como corresponde con su alias. Tambien tiene un action porque es la nueva data del producto. Para ello agregamos la property en el path con su alias.
 */
